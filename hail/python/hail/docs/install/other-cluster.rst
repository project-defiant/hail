...
Hail should work with any Spark 4.1.x cluster built with Scala 2.12.
...
.. code-block:: sh
    ...
    cd hail/hail
    make install-on-cluster HAIL_COMPILE_NATIVES=1 SCALA_VERSION=2.12.18 SPARK_VERSION=4.1.0
