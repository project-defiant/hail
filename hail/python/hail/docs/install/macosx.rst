...
- Install Java 17. We recommend using a `packaged installation from Temurin
  <https://adoptium.net/temurin/releases/?os=mac&arch=arm&version=17>`__
  ...
  You *must* pick a Java 17 installation with a compatible architecture. If your processor uses Apple M-series silicon
